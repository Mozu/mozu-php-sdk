...
class ProductExtraClient {
	...
	* @return MozuClient
	*/
	public static function getExtrasClient($dataViewMode, $productCode, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
	...
	* @return MozuClient
	*/
	public static function getExtraClient($dataViewMode, $productCode, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
	...
	* @return MozuClient
	*/
	public static function addExtraClient($dataViewMode, $productExtra, $productCode, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
	...
	* @return MozuClient
	*/
	public static function updateExtraClient($dataViewMode, $productExtra, $productCode, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
	...
	* @param string $productCode "Merchant-created code that uniquely identifies the product such as a SKU or item number. Once created, the product code is read-only."
	*/
	public static function deleteExtraClient($dataViewMode, $productCode, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
