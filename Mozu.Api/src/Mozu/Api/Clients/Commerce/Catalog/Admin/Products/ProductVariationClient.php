...
class ProductVariationClient {
	...
	* @return MozuClient
	*/
	public static function getProductVariationClient($productCode, $variationKey)
	{
	...
	* @return MozuClient
	*/
	public static function getProductVariationsClient($filter, $pageSize, $productCode, $sortBy, $startIndex)
	{
	...
	* @return MozuClient
	*/
	public static function updateProductVariationsClient($productCode, $productVariations)
	{
		$url = ProductVariationUrl::updateProductVariationsUrl($productCode);
		$verb = "PUT";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($productVariations);
		return $mozuClient;
	...
	* @return MozuClient
	*/
	public static function updateProductVariationClient($productCode, $variationKey, $productVariation)
	{
		$url = ProductVariationUrl::updateProductVariationUrl($productCode, $variationKey);
		$verb = "PUT";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($productVariation);
		return $mozuClient;
	...
	* @param string $variationKey System-generated key that represents the attribute values that uniquely identify a specific product variation.
	*/
	public static function deleteProductVariationClient($productCode, $variationKey)
	{
