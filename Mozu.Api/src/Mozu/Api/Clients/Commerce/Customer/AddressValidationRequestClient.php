...
class AddressValidationRequestClient {
	...
	* @return MozuClient
	*/
	public static function validateAddressClient($addressValidationRequest, Mozu\Api\Security\AuthTicket &$authTicket= null)
	{
		$url = AddressValidationRequestUrl::validateAddressUrl();
		$mozuClient = new MozuClient();
		$mozuClient->withResourceUrl($url)->withBody($addressValidationRequest);		if ($authTicket != null)
