...
class CreditClient {
	...
	* @return MozuClient
	*/
	public static function addCreditClient($credit, Mozu\Api\Security\AuthTicket &$authTicket= null)
	{
		$url = CreditUrl::addCreditUrl();
		$mozuClient = new MozuClient();
		$mozuClient->withResourceUrl($url)->withBody($credit);		if ($authTicket != null)
			$mozuClient = $mozuClient->withUserAuth($authTicket);
		return $mozuClient;
