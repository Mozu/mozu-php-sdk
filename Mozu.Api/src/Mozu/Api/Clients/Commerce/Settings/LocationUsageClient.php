...
class LocationUsageClient {
	...
	* @return MozuClient
	*/
	public static function getLocationUsagesClient(Mozu\Api\Security\AuthTicket &$authTicket= null)
	{
	...
	*/
	public static function updateLocationUsageClient($usage,  $code, Mozu\Api\Security\AuthTicket &$authTicket= null)
	{
		...
		$mozuClient = new MozuClient();
		$mozuClient->withResourceUrl($url)->withBody($usage);		if ($authTicket != null)
			$mozuClient = $mozuClient->withUserAuth($authTicket);
		return $mozuClient;
