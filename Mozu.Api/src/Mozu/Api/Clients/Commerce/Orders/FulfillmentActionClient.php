...
class FulfillmentActionClient {
	...
	*/
	...
	{
		$url = FulfillmentActionUrl::getFulfillmentInfoUrl($draft, $orderId);
	...
	*/
	...
	{
		$url = FulfillmentActionUrl::setFulFillmentInfoUrl($orderId, $updateMode, $version);
		$mozuClient = new MozuClient();
		$mozuClient->withResourceUrl($url)->withBody($fulfillmentInfo);		if ($authTicket != null)
			$mozuClient = $mozuClient->withUserAuth($authTicket);
		return $mozuClient;
