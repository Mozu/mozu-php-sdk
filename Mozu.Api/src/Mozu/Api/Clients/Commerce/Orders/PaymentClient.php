...
class PaymentClient {
	...
	* @return MozuClient
	*/
	public static function getPaymentsClient($orderId)
	{
	...
	* @return MozuClient
	*/
	public static function getPaymentClient($orderId, $paymentId)
	{
	...
	* @return MozuClient
	*/
	public static function performPaymentActionClient($orderId, $paymentId, $action)
	{
	...
	* @return MozuClient
	*/
	public static function createPaymentActionClient($orderId, $action)
	{
