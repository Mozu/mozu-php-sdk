...
*/
class FolderTreeResource extends BaseResource {
	...
	* @return FolderTree 
	*/
	public function getFolderTree($documentListName, $levels, $rootFolderId, $rootFolderPath)
	{
		$mozuClient = FolderTreeClient::getFolderTreeClient($documentListName, $levels, $rootFolderId, $rootFolderPath);
