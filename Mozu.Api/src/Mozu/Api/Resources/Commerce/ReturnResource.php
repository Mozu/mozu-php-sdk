...
class ReturnResource extends BaseResource {
	...
	*/
	public function getReturns($filter, $pageSize, $sortBy, $startIndex)
	{
		$mozuClient = ReturnClient::getReturnsClient($filter, $pageSize, $sortBy, $startIndex);
	...
	*/
	...
	{
		$mozuClient = ReturnClient::getReturnClient($returnId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function getPayments($returnId)
	{
		$mozuClient = ReturnClient::getPaymentsClient($returnId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Payment 
	*/
	public function getPayment($paymentId, $returnId)
	{
		$mozuClient = ReturnClient::getPaymentClient($paymentId, $returnId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return array|string 
	*/
	public function getAvailablePaymentActionsForReturn($paymentId, $returnId)
	{
		$mozuClient = ReturnClient::getAvailablePaymentActionsForReturnClient($paymentId, $returnId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Return 
	*/
	public function createReturn($ret)
	{
		$mozuClient = ReturnClient::createReturnClient($ret);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Return 
	*/
	public function performPaymentActionForReturn($paymentId, $returnId, $action)
	{
		$mozuClient = ReturnClient::performPaymentActionForReturnClient($paymentId, $returnId, $action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Return 
	*/
	public function createPaymentActionForReturn($returnId, $action)
	{
		$mozuClient = ReturnClient::createPaymentActionForReturnClient($returnId, $action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return ReturnCollection 
	*/
	public function performReturnActions($action)
	{
		$mozuClient = ReturnClient::performReturnActionsClient($action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Return 
	*/
	public function updateReturn($returnId, $ret)
	{
		$mozuClient = ReturnClient::updateReturnClient($returnId, $ret);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
