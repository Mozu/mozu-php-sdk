...
*/
class ProductTypeOptionResource extends BaseResource {
	...
	*/
	...
	{
		$mozuClient = ProductTypeOptionClient::getOptionsClient($productTypeId);
	...
	*/
	public function getOption($attributeFQN, $productTypeId)
	{
		$mozuClient = ProductTypeOptionClient::getOptionClient($attributeFQN, $productTypeId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return AttributeInProductType 
	*/
	public function addOption($productTypeId, $attributeInProductType)
	{
		$mozuClient = ProductTypeOptionClient::addOptionClient($productTypeId, $attributeInProductType);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return AttributeInProductType 
	*/
	public function updateOption($attributeFQN, $productTypeId, $attributeInProductType)
	{
		$mozuClient = ProductTypeOptionClient::updateOptionClient($attributeFQN, $productTypeId, $attributeInProductType);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @param int $productTypeId Identifier of the product type.
	*/
	public function deleteOption($attributeFQN, $productTypeId)
	{
		$mozuClient = ProductTypeOptionClient::deleteOptionClient($attributeFQN, $productTypeId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
