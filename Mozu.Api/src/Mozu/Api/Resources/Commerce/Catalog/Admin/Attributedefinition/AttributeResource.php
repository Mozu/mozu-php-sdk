...
class AttributeResource {
	...
	*/
	public function getAttributes($dataViewMode, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = AttributeClient::getAttributesClient($dataViewMode, $startIndex, $pageSize, $sortBy, $filter, $userAuthTicket);
	...
	* @return Attribute 
	*/
	public function getAttribute($dataViewMode, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = AttributeClient::getAttributeClient($dataViewMode, $attributeFQN, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Attribute 
	*/
	public function addAttribute($dataViewMode, $attribute, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = AttributeClient::addAttributeClient($dataViewMode, $attribute, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Attribute 
	*/
	public function updateAttribute($dataViewMode, $attribute, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = AttributeClient::updateAttributeClient($dataViewMode, $attribute, $attributeFQN, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @param string $attributeFQN "The fully qualified name of the attribute, which is a user defined attribute identifier."
	*/
	public function deleteAttribute($dataViewMode, $attributeFQN, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = AttributeClient::deleteAttributeClient($dataViewMode, $attributeFQN, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
