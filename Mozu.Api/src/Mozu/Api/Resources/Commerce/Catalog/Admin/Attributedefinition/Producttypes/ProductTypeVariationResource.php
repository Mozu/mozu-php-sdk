...
class ProductTypeVariationResource {
	...
	*/
	public function generateProductVariations($dataViewMode, $productOptionsIn, $productTypeId, $productCode =  null, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductTypeVariationClient::generateProductVariationsClient($dataViewMode, $productOptionsIn, $productTypeId, $productCode, $startIndex, $pageSize, $sortBy, $filter, $userAuthTicket);
