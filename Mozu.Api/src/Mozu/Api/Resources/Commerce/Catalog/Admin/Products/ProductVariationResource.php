...
class ProductVariationResource {
	...
	*/
	public function getProductVariation($dataViewMode, $productCode, $variationKey, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductVariationClient::getProductVariationClient($dataViewMode, $productCode, $variationKey, $userAuthTicket);
	...
	*/
	public function getProductVariations($dataViewMode, $productCode, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductVariationClient::getProductVariationsClient($dataViewMode, $productCode, $startIndex, $pageSize, $sortBy, $filter, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function updateProductVariations($dataViewMode, $productVariations, $productCode, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductVariationClient::updateProductVariationsClient($dataViewMode, $productVariations, $productCode, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return ProductVariation 
	*/
	public function updateProductVariation($dataViewMode, $productVariation, $productCode, $variationKey, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductVariationClient::updateProductVariationClient($dataViewMode, $productVariation, $productCode, $variationKey, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @param string $variationKey System-generated key that represents the attribute values that uniquely identify a specific product variation.
	*/
	public function deleteProductVariation($dataViewMode, $productCode, $variationKey, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = ProductVariationClient::deleteProductVariationClient($dataViewMode, $productCode, $variationKey, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
