...
*/
class AttributeTypeRuleResource extends BaseResource {
	...
	*/
	public function getAttributeTypeRules($filter, $pageSize, $sortBy, $startIndex)
	{
		$mozuClient = AttributeTypeRuleClient::getAttributeTypeRulesClient($filter, $pageSize, $sortBy, $startIndex);
