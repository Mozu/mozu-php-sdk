...
class ProductResource extends BaseResource {
	...
	*/
	public function getProducts($filter, $pageSize, $sortBy, $startIndex)
	{
		$mozuClient = ProductClient::getProductsClient($filter, $pageSize, $sortBy, $startIndex);
	...
	* @return Product 
	*/
	public function getProduct($allowInactive, $productCode, $variationProductCode)
	{
		$mozuClient = ProductClient::getProductClient($allowInactive, $productCode, $variationProductCode);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function configuredProduct($includeOptionDetails, $productCode, $productOptionSelections)
	{
		$mozuClient = ProductClient::configuredProductClient($includeOptionDetails, $productCode, $productOptionSelections);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function validateProduct($productCode, $productOptionSelections)
	{
		$mozuClient = ProductClient::validateProductClient($productCode, $productOptionSelections);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
