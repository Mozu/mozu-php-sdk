...
class OrderItemResource extends BaseResource {
	...
	* @return OrderItem 
	*/
	public function getOrderItem($draft, $orderId, $orderItemId)
	{
		$mozuClient = OrderItemClient::getOrderItemClient($draft, $orderId, $orderItemId);
	...
	*/
	public function getOrderItems($draft, $orderId)
	{
		$mozuClient = OrderItemClient::getOrderItemsClient($draft, $orderId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function createOrderItem($orderId, $updateMode, $version, $orderItem)
	{
		$mozuClient = OrderItemClient::createOrderItemClient($orderId, $updateMode, $version, $orderItem);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function updateOrderItemDiscount($discountId, $orderId, $orderItemId, $updateMode, $version, $discount)
	{
		$mozuClient = OrderItemClient::updateOrderItemDiscountClient($discountId, $orderId, $orderItemId, $updateMode, $version, $discount);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function updateItemProductPrice($orderId, $orderItemId, $price, $updateMode, $version)
	{
	...
	* @return Order 
	*/
	public function updateItemQuantity($orderId, $orderItemId, $quantity, $updateMode, $version)
	{
	...
	* @return Order 
	*/
	public function deleteOrderItem($orderId, $orderItemId, $updateMode, $version)
	{
