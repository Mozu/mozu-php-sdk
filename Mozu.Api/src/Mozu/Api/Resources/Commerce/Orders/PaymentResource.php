...
class PaymentResource extends BaseResource {
	...
	* @return Order 
	*/
	public function performPaymentAction($orderId, $paymentId, $action)
	{
		$mozuClient = PaymentClient::performPaymentActionClient($orderId, $paymentId, $action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function createPaymentAction($orderId, $action)
	{
		$mozuClient = PaymentClient::createPaymentActionClient($orderId, $action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
