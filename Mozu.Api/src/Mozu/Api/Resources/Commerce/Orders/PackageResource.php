...
class PackageResource extends BaseResource {
	...
	* @return Package 
	*/
	public function createPackage($orderId, $pkg)
	{
		$mozuClient = PackageClient::createPackageClient($orderId, $pkg);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Package 
	*/
	public function updatePackage($orderId, $packageId, $pkg)
	{
		$mozuClient = PackageClient::updatePackageClient($orderId, $packageId, $pkg);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
