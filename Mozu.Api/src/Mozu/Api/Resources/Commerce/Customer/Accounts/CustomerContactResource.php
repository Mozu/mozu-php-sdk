...
*/
class CustomerContactResource extends BaseResource {
	...
	*/
	public function getAccountContacts($accountId, $filter, $pageSize, $sortBy, $startIndex)
	{
		$mozuClient = CustomerContactClient::getAccountContactsClient($accountId, $filter, $pageSize, $sortBy, $startIndex);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerContact 
	*/
	public function addAccountContact($accountId, $contact)
	{
		$mozuClient = CustomerContactClient::addAccountContactClient($accountId, $contact);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerContact 
	*/
	public function updateAccountContact($accountId, $contactId, $contact)
	{
		$mozuClient = CustomerContactClient::updateAccountContactClient($accountId, $contactId, $contact);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
