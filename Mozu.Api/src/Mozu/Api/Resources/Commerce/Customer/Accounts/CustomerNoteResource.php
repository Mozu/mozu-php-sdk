...
class CustomerNoteResource {
	...
	*/
	public function getAccountNotes($accountId, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null)
	{
		$mozuClient = CustomerNoteClient::getAccountNotesClient($accountId, $startIndex, $pageSize, $sortBy, $filter);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerNote 
	*/
	public function addAccountNote($note, $accountId)
	{
		$mozuClient = CustomerNoteClient::addAccountNoteClient($note, $accountId);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerNote 
	*/
	public function updateAccountNote($note, $accountId, $noteId)
	{
		$mozuClient = CustomerNoteClient::updateAccountNoteClient($note, $accountId, $noteId);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
