...
class CustomerNoteResource {
	...
	* @return CustomerNote 
	*/
	public function getAccountNote($accountId, $noteId, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = CustomerNoteClient::getAccountNoteClient($accountId, $noteId, $userAuthTicket);
	...
	*/
	public function getAccountNotes($accountId, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = CustomerNoteClient::getAccountNotesClient($accountId, $startIndex, $pageSize, $sortBy, $filter, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerNote 
	*/
	public function addAccountNote($note, $accountId, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = CustomerNoteClient::addAccountNoteClient($note, $accountId, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return CustomerNote 
	*/
	public function updateAccountNote($note, $accountId, $noteId, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = CustomerNoteClient::updateAccountNoteClient($note, $accountId, $noteId, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function deleteAccountNote($accountId, $noteId, Mozu\Api\Security\AuthTicket &$userAuthTicket= null)
	{
		$mozuClient = CustomerNoteClient::deleteAccountNoteClient($accountId, $noteId, $userAuthTicket);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
