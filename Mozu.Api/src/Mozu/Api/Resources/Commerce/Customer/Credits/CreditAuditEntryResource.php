...
class CreditAuditEntryResource {
	...
	*/
	public function getAuditEntries($code, $startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null)
	{
		$mozuClient = CreditAuditEntryClient::getAuditEntriesClient($code, $startIndex, $pageSize, $sortBy, $filter);
