...
class ChannelResource {
	...
	*/
	public function getChannels($startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null)
	{
		$mozuClient = ChannelClient::getChannelsClient($startIndex, $pageSize, $sortBy, $filter);
	...
	*/
	...
	{
		$mozuClient = ChannelClient::getChannelClient($code);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = ChannelClient::createChannelClient($channel);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Channel 
	*/
	public function updateChannel($channel, $code)
	{
		$mozuClient = ChannelClient::updateChannelClient($channel, $code);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
