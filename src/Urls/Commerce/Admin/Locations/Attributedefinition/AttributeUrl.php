...
namespace Mozu\Api\Urls\Commerce\Admin\Locations\Attributedefinition;
...
class AttributeUrl  {
	...
	*/
	...
	{
		$url = "/api/commerce/admin/locations/attributedefinition/attributes/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&responseFields={responseFields}";
	...
	*/
	...
	{
		$url = "/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}/VocabularyValues";
		$mozuUrl = new MozuUrl($url, UrlLocation::TENANT_POD,"GET", false) ;
	...
	*/
	...
	{
		$url = "/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}?responseFields={responseFields}";
		$mozuUrl = new MozuUrl($url, UrlLocation::TENANT_POD,"GET", false) ;
		$url = $mozuUrl->formatUrl("attributeFQN", $attributeFQN);
		$url = $mozuUrl->formatUrl("responseFields", $responseFields);
		return $mozuUrl;
	...
	*/
	...
	{
		$url = "/api/commerce/admin/locations/attributedefinition/attributes/?responseFields={responseFields}";
