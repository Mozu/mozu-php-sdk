...
class AttributeUrl  {
	...
	*/
	...
	{
		$url = "/api/commerce/customer/accountattributedefinition/attributes/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&responseFields={responseFields}";
	...
	*/
	...
	{
		$url = "/api/commerce/customer/accountattributedefinition/attributes/{attributeFQN}/VocabularyValues";
		$mozuUrl = new MozuUrl($url, UrlLocation::TENANT_POD,"GET", false) ;
	...
	*/
	...
	{
		$url = "/api/commerce/customer/accountattributedefinition/attributes/{attributeFQN}?responseFields={responseFields}";
		$mozuUrl = new MozuUrl($url, UrlLocation::TENANT_POD,"GET", false) ;
		$url = $mozuUrl->formatUrl("attributeFQN", $attributeFQN);
		$url = $mozuUrl->formatUrl("responseFields", $responseFields);
		return $mozuUrl;
	...
	*/
	...
	{
		$url = "/api/commerce/customer/accountattributedefinition/attributes/?responseFields={responseFields}";
