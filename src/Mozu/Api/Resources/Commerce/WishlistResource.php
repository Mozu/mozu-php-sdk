...
class WishlistResource {
	...
	*/
	public function getWishlists($startIndex =  null, $pageSize =  null, $sortBy =  null, $filter =  null, $q =  null, $qLimit =  null)
	{
		$mozuClient = WishlistClient::getWishlistsClient($startIndex, $pageSize, $sortBy, $filter, $q, $qLimit);
	...
	*/
	...
	{
		$mozuClient = WishlistClient::getWishlistClient($wishlistId);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Wishlist 
	*/
	public function getWishlistByName($customerAccountId, $wishlistName)
	{
		$mozuClient = WishlistClient::getWishlistByNameClient($customerAccountId, $wishlistName);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = WishlistClient::createWishlistClient($wishlist);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Wishlist 
	*/
	public function updateWishlist($wishlist, $wishlistId)
	{
		$mozuClient = WishlistClient::updateWishlistClient($wishlist, $wishlistId);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
