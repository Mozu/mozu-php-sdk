...
class OrderResource extends BaseResource {
	...
	*/
	public function getOrders($filter, $pageSize, $q, $qLimit, $sortBy, $startIndex)
	{
		$mozuClient = OrderClient::getOrdersClient($filter, $pageSize, $q, $qLimit, $sortBy, $startIndex);
	...
	* @return Order 
	*/
	public function getOrder($draft, $orderId)
	{
		$mozuClient = OrderClient::getOrderClient($draft, $orderId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function performOrderAction($orderId, $action)
	{
		$mozuClient = OrderClient::performOrderActionClient($orderId, $action);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Order 
	*/
	public function updateOrderDiscount($discountId, $orderId, $updateMode, $version, $discount)
	{
		$mozuClient = OrderClient::updateOrderDiscountClient($discountId, $orderId, $updateMode, $version, $discount);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function deleteOrderDraft($orderId, $version)
	{
	...
	* @return Order 
	*/
	public function updateOrder($orderId, $updateMode, $version, $order)
	{
		$mozuClient = OrderClient::updateOrderClient($orderId, $updateMode, $version, $order);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
