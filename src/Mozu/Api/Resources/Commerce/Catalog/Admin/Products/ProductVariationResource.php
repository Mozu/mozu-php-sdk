...
*/
class ProductVariationResource extends BaseResource {
	...
	*/
	public function getProductVariation($productCode, $variationKey)
	{
		$mozuClient = ProductVariationClient::getProductVariationClient($productCode, $variationKey);
	...
	*/
	public function getProductVariations($filter, $pageSize, $productCode, $sortBy, $startIndex)
	{
		$mozuClient = ProductVariationClient::getProductVariationsClient($filter, $pageSize, $productCode, $sortBy, $startIndex);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	public function updateProductVariations($productCode, $productVariations)
	{
		$mozuClient = ProductVariationClient::updateProductVariationsClient($productCode, $productVariations);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return ProductVariation 
	*/
	public function updateProductVariation($productCode, $variationKey, $productVariation)
	{
		$mozuClient = ProductVariationClient::updateProductVariationClient($productCode, $variationKey, $productVariation);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = ProductVariationClient::deleteProductVariationClient($productCode, $variationKey);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
