...
class FacetResource extends BaseResource {
	...
	* @return Facet 
	*/
	public function getFacet($facetId, $validate)
	{
		$mozuClient = FacetClient::getFacetClient($facetId, $validate);
	...
	* @return FacetSet 
	*/
	public function getFacetCategoryList($categoryId, $includeAvailable, $validate)
	{
		$mozuClient = FacetClient::getFacetCategoryListClient($categoryId, $includeAvailable, $validate);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = FacetClient::addFacetClient($facet);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return Facet 
	*/
	public function updateFacet($facetId, $facet)
	{
		$mozuClient = FacetClient::updateFacetClient($facetId, $facet);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
