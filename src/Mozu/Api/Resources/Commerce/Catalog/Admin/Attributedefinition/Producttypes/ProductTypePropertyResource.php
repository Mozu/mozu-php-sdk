...
class ProductTypePropertyResource {
	...
	*/
	public function getProperty($dataViewMode, $productTypeId, $attributeFQN, $responseFields =  null)
	{
		$mozuClient = ProductTypePropertyClient::getPropertyClient($dataViewMode, $productTypeId, $attributeFQN, $responseFields);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return AttributeInProductType 
	*/
	public function addProperty($dataViewMode, $attributeInProductType, $productTypeId, $responseFields =  null)
	{
		$mozuClient = ProductTypePropertyClient::addPropertyClient($dataViewMode, $attributeInProductType, $productTypeId, $responseFields);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return AttributeInProductType 
	*/
	public function updateProperty($dataViewMode, $attributeInProductType, $productTypeId, $attributeFQN, $responseFields =  null)
	{
		$mozuClient = ProductTypePropertyClient::updatePropertyClient($dataViewMode, $attributeInProductType, $productTypeId, $attributeFQN, $responseFields);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
