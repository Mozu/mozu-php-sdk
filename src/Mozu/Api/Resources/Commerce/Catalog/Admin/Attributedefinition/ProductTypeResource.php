...
class ProductTypeResource extends BaseResource {
	...
	*/
	public function getProductTypes($filter, $pageSize, $sortBy, $startIndex)
	{
		$mozuClient = ProductTypeClient::getProductTypesClient($filter, $pageSize, $sortBy, $startIndex);
	...
	*/
	...
	{
		$mozuClient = ProductTypeClient::getProductTypeClient($productTypeId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = ProductTypeClient::addProductTypeClient($productType);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	* @return ProductType 
	*/
	public function updateProductType($productTypeId, $productType)
	{
		$mozuClient = ProductTypeClient::updateProductTypeClient($productTypeId, $productType);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
		return $mozuClient->getResult();
	...
	*/
	...
	{
		$mozuClient = ProductTypeClient::deleteProductTypeClient($productTypeId);
		$mozuClient = parent::SetContext($this->apiContext, $mozuClient,TRUE);
		$mozuClient->execute();
