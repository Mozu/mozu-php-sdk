...
class ProductSearchResultResource {
	...
	*/
	...
	{
		$mozuClient = ProductSearchResultClient::searchClient($query, $filter, $facetTemplate, $facetTemplateSubset, $facet, $facetFieldRangeQuery, $facetHierPrefix, $facetHierValue, $facetHierDepth, $facetStartIndex, $facetPageSize, $facetSettings, $facetValueFilter, $sortBy, $pageSize, $startIndex);
	...
	*/
	public function suggest($q =  null, $pageSize =  null)
	{
		$mozuClient = ProductSearchResultClient::suggestClient($q, $pageSize);
		$mozuClient = $mozuClient->withContext($this->apiContext);
		$mozuClient->execute();
		return $mozuClient->getResult();
