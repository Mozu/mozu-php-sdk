...
class BillingInfoUrl  {
	...
	*/
	public static function getBillingInfoUrl($draft, $orderId, $responseFields)
	{
		$url = "/api/commerce/orders/{orderId}/billinginfo?draft={draft}&responseFields={responseFields}";
