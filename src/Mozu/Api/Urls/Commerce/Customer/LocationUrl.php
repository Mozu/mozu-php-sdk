...
class LocationUrl extends BaseUrl {
	...
	*/
	...
	{
		$url = "/api/commerce/customer/locations/locations/{locationId}";
	...
	*/
	...
	{
		$url = "/api/commerce/customer/locations/locations?name={name}&";
	...
	*/
	...
	{
		$url = "/api/commerce/customer/locations/locations?pageIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&&filter={filter}";
