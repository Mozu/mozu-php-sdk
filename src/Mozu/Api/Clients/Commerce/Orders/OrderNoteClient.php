...
class OrderNoteClient {
	...
	* @return MozuClient
	*/
	public static function getOrderNoteClient($noteId, $orderId)
	{
	...
	* @return MozuClient
	*/
	public static function createOrderNoteClient($orderId, $orderNote)
	{
		$url = OrderNoteUrl::createOrderNoteUrl($orderId);
		$verb = "POST";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($orderNote);
		return $mozuClient;
	...
	* @return MozuClient
	*/
	public static function updateOrderNoteClient($noteId, $orderId, $orderNote)
	{
	...
	*/
	public static function deleteOrderNoteClient($noteId, $orderId)
	{
