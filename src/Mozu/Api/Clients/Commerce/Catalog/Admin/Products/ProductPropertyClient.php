...
class ProductPropertyClient {
	...
	* @return MozuClient
	*/
	public static function getPropertiesClient($productCode)
	{
	...
	* @return MozuClient
	*/
	public static function getPropertyClient($attributeFQN, $productCode)
	{
	...
	* @return MozuClient
	*/
	public static function addPropertyClient($productCode, $productProperty)
	{
		$url = ProductPropertyUrl::addPropertyUrl($productCode);
		$verb = "POST";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($productProperty);
		return $mozuClient;
	...
	* @return MozuClient
	*/
	public static function updatePropertyClient($attributeFQN, $productCode, $productProperty)
	{
	...
	*/
	public static function deletePropertyClient($attributeFQN, $productCode)
	{
