...
class ProductTypeClient {
	...
	* @return MozuClient
	*/
	public static function getProductTypesClient($filter, $pageSize, $sortBy, $startIndex)
	{
	...
	* @return MozuClient
	*/
	public static function getProductTypeClient($productTypeId)
	{
	...
	* @return MozuClient
	*/
	public static function addProductTypeClient($productType)
	{
		$url = ProductTypeUrl::addProductTypeUrl();
		$verb = "POST";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($productType);
		return $mozuClient;
	...
	* @return MozuClient
	*/
	public static function updateProductTypeClient($productTypeId, $productType)
	{
	...
	*/
	public static function deleteProductTypeClient($productTypeId)
	{
