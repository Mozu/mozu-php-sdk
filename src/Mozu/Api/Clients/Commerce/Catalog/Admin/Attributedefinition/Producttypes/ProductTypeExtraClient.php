...
class ProductTypeExtraClient {
	...
	* @return MozuClient
	*/
	public static function getExtrasClient($productTypeId)
	{
	...
	* @return MozuClient
	*/
	public static function getExtraClient($attributeFQN, $productTypeId)
	{
	...
	* @return MozuClient
	*/
	public static function addExtraClient($productTypeId, $attributeInProductType)
	{
	...
	* @return MozuClient
	*/
	public static function updateExtraClient($attributeFQN, $productTypeId, $attributeInProductType)
	{
	...
	* @param int $productTypeId Identifier of the product type.
	*/
	public static function deleteExtraClient($attributeFQN, $productTypeId)
	{
