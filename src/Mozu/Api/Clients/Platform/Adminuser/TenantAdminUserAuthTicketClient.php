...
class TenantAdminUserAuthTicketClient {
	...
	* @return MozuClient
	*/
	public static function createUserAuthTicketClient($tenantId, $userAuthInfo)
	{
	...
	* @return MozuClient
	*/
	public static function refreshAuthTicketClient($tenantId, $existingAuthTicket)
	{
		$url = TenantAdminUserAuthTicketUrl::refreshAuthTicketUrl($tenantId);
		$verb = "PUT";
		$mozuClient = new MozuClient();
		$mozuClient->withVerb($verb)
				->withResourceUrl($url)->withBody($existingAuthTicket);
		return $mozuClient;
